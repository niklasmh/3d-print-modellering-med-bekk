...
---
<!-- header: 5 grunner til å forme plastikk? 🖐️ -->
...
---
<!-- header: Så... hvordan former man plastikk? 🧱 ➔ 🗿 -->
...
Det finnes flere måter å forme plastikk på, men dette er dagens billigste og kjappeste
...
---
<!-- header: La oss se på noen typer -->
...
---
<!-- header: Finnes flere måter å printe på -->
...
---
<!-- header: Gratis verktøy for å lage modeller -->
# Tinkercad
...
![bg right contain](cube-scale.png)

---

## Rotere objekter

Bruk `rotate([x, y, z])(model)`
...
![bg right:40% vertical](2d-polygon.png)
...
![bg right contain](import-stl.png)
...
---
<!-- header: Ting man bør tenke ut før man modellerer -->
1. Overheng: Kant
...
Igjen, support kan fikses automatisk av 3D-printer software
